...
function calculateFinalScore(obj) {
  ...
  let total_mark = obj.testScore + obj.schoolGrade;
  if (obj.isFFamily) {
    total_mark += 20;
  }
  if (obj.isFFamily && total_mark >= 80) {
    return true;
  } else if (obj.isFFamily && total_mark < 80) {
    return false;
  } else if (!obj.isFFamily && total_mark >= 80) {
    return true;
  } else {
...
// const student = {
//   name: "Sabuj",
//   testScore: 15, //testScore <= 50 and number
//   schoolGrade: 25, // schoolGrade <=30 and number
//   isFFamily: true,
// };
